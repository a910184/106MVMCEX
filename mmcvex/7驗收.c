...
int norc=0,eq=0,cal,value,b,fir,tem,play,shortclear,special=0,cal1,enter,sp0=0,sp1=0,bit,bit1,bit2=0;//bit等號後輸入數字sp0 溢位 enter 數字鍵輸入專屬 special 等號輸入顯示旗標
...
{
case 0: cal2=0;break;
case 1: cal2=(int)I[3]-0x30;break;
case 2: cal2=((int)I[2]-0x30)*10+(int)I[3]-0x30;break;
case 3: cal2=((int)I[1]-0x30)*100+((int)I[2]-0x30)*10+(int)I[3]-0x30;break;
case 4: cal2=((int)I[0]-0x30)*1000+((int)I[1]-0x30)*100+((int)I[2]-0x30)*10+(int)I[3]-0x30;break;
}
printf("I=%c%c%c%c\n",I[0],I[1],I[2],I[3]);
printf("cal2=%d,b=%d\n",cal2,b);
