...
int a,keyboard=0,zero= 0x30;// a為數值暫存,b為轉換後的實際數值
int norc=0,temp=0,eq=0,cal,value,b,fir,tem,play,shortclear,special=0,cal1,enter,sp0=0,sp1=0,bit,bit1=0,bit2=0;//bit等號後輸入數字sp0 溢位 enter 數字鍵輸入專屬 special 等號輸入顯示旗標
