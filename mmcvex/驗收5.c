...
int main(void)
{
	ASA_M128_set();
	char I_PORT,O_PORT;
	int I_bit,O_bit,reset,ibyte,obyte,omask,imask,idata,odata,time,pshift,pmask,pbyte,gmask,gbyte,data=0,gshift,check1,check2,shift=4,a;
	...
	switch (O_bit)
	{
		case 0:omask=0x01;odata=0x10;odata=odata>>shift; break;
		case 1:omask=0x02;odata=0x20;odata=odata>>shift; break;
		case 2:omask=0x04;odata=0x40;odata=odata>>shift; break;
		case 3:omask=0x08;odata=0x80;odata=odata>>shift; break;
		case 4:omask=0x10;odata=0x01;odata=odata<<shift;break;
		case 5:omask=0x20;odata=0x02;odata=odata<<shift ;break;
		case 6:omask=0x40;odata=0x04;odata=odata<<shift ;break;
		case 7:omask=0x80;odata=0x08;odata=odata<<shift ;break;
	}
	a=M128_DIO_set(obyte,omask,0,odata);
